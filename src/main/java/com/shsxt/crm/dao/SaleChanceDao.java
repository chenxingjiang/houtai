...
public interface SaleChanceDao {
	...
	public SaleChance queryById(Integer id);
	
	
	public Integer deleteSaleChance(Integer[] ids);

	@Update("update t_sale_chance set dev_result=#{devResult} where id=#{sid} and is_valid=1")
	public Integer updateSaleChanceDevResult(@Param("sid")Integer sid, @Param("devResult")Integer devResult);
